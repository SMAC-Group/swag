...
train_pred <- predict(train_swag_svmr,newdata = x_train, type="cv_performance",cv_performance = 0.05)

# predictions for a given dimension in-sample
train_pred_att <- predict(train_swag_svmr,newdata = x_train,type="attribute",attribute = 4)
